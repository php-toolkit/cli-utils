...
class ColorCode
{
    ...
    public const KNOWN_OPTIONS = [
        'bold'       => ANSICode::BOLD,       // 加粗
        'fuzzy'      => ANSICode::FUZZY,      // 模糊(不是所有的终端仿真器都支持)
        'italic'     => ANSICode::ITALIC,     // 斜体(不是所有的终端仿真器都支持)
        'underscore' => ANSICode::UNDERSCORE, // 下划线
        'blink'      => ANSICode::BLINK,      // 闪烁
        'reverse'    => ANSICode::REVERSE,    // 颠倒的 交换背景色与前景色
        'concealed'  => ANSICode::CONCEALED,  // 隐匿的
    ];
